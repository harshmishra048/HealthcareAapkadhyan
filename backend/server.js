...
const superAdminLabRoutes = require("./src/routes/superAdminLabRoutes");
...
app.use("/api/super-admin-labs", requireFeature("labs", "Labs"), superAdminLabRoutes);
app.use("/api/medicine-requests", medicineRequestRoutes);
app.use("/api/medical-owner-dashboard", medicalOwnerDashboardRoutes);
app.use("/api/labs", requireFeature("labs", "Labs"), labRoutes);
